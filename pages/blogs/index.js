           ...
           <Search/>
            <Layout>
                <main>
                        ...
                        <header>
                            <div className="col-md-12 pt-3 pb-3">
                                <h1 className="display-4 font-weight-bold text-center">
                                    Start exploring blogs of your interest!
                                </h1>
                            </div>
                            <section>
                    ...
                    <div className="container-fluid pl-5 pr-5" >{showAllBlogs()}</div>
                    <div className="container-fluid pl-5 pr-5">{showLoadedBlogs()}</div>
